...
class User(AbstractBaseUser):
    ...
    username     = models.CharField(max_length=256, verbose_name='نام کاربری', unique=True, help_text='این نام برای تنظیم جدول داده ها به کار میرود')
    ...
    role         = models.PositiveSmallIntegerField(choices=ROLE, verbose_name='نقش', default=3)
